...
<style>
      ...
      <div class="row g-4">
        <div class="col-12 col-md-6">
          ...
          <div class="row mt-2">
            ...
            <div class="col">
              ...
              <input type="text" name="last_name" id="last-name" class="form-control border-midnight-blue" value="{{ old('last_name') }}">
            </div>
          </div>
        ...
        <div class="col-12 col-md-6">
          ...
          <div class="w-100 mt-2">
            <input type="radio" id="service1" name="shipping_service" class="service" value="reguler" hidden checked {{ old('shipping_service') == 'reguler' ? 'checked' : ''}}>
          ...
          <div class="w-100">
            <input type="radio" id="service2" name="shipping_service" class="service" value="one day service" hidden {{ old('shipping_service') == 'one day service' ? 'checked' : ''}}>
          ...
          <div class="w-100 p-0 border-midnight-blue rounded" style="overflow: hidden">
            ...
            <div class="row bg-midnight-blue m-0 py-2 light-blue">
              <div class="col">Subtotal : </div>
              <div id="subtotal" class="col text-end">Rp{{number_format(($product->price - ($product->discount * $product->price / 100)) * $quantity + 12000 + 20000, 2, ',', '.')}}</div>
            </div>
          </div>
  ...
  <script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
      const radios = document.querySelectorAll('input[name="shipping_service"]');
