    ...
    <div class="container my-4" style="min-height: 74.2vh">
      <div class="row g-2">
        ...
        <div class="col col-12 col-md-6">
          ...
          <a href="/checkout" class="d-block dc-none rounded-5 p-2 bg-midnight-blue light-blue text-center my-2">BELI SEKARANG</a>
          <a href="/cart" class="d-block dc-none rounded-5 p-2 bg-steel-blue light-blue text-center my-2">TAMBAH KE KERANJANG</a>
          <button onclick="history.back()" class="d-block dc-none rounded-5 p-2 bg-light-steel-blue midnight-blue text-center my-2 w-100">KEMBALI</button>
        </div>
      </div>
